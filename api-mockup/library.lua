...
function Library()
    ...
    ---@return vec3 value The vec3 solution of the above system
    ...
    ---@return vec3 value The position in percentage (between 0 and 1) of the screen resolution as vec3 with {x, y, depth}
